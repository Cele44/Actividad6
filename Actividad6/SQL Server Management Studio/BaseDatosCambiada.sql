...
select * from ROL
insert into usuario values (1, 'pedrof', '6841',CONVERT(datetime, '2022-02-01 14:00:00',120));
insert into usuario values (2, 'adrianp', '2847',CONVERT(datetime, '2022-02-23 13:50:00',120));
insert into usuario values (3, 'beleng', '9189',CONVERT(datetime, '2022-03-15 09:20:00',120));
insert into usuario values (4, 'anar', '5539',CONVERT(datetime, '2022-05-20 18:25:00',120));
insert into usuario values (5, 'brunol', '2664',CONVERT(datetime, '2022-05-21 15:30:00',120));
insert into usuario values (6, 'carlag', '7655',CONVERT(datetime, '2022-06-06 16:45:00',120));
insert into usuario values (7, 'diegos', '7655',CONVERT(datetime, '2022-06-06 12:32:00',120));
insert into usuario values (8, 'elenam', '9048',CONVERT(datetime, '2022-08-14 12:01:00',120));
insert into usuario values (9, 'fabiang', '3590',CONVERT(datetime, '2022-09-30 11:28:00',120));
insert into usuario values (10, 'gloriad', '4916',CONVERT(datetime, '2022-10-29 14:11:00',120));
insert into usuario values (11, 'hugor', '9719',CONVERT(datetime, '2022-12-27 10:15:00',120));
insert into usuario values (12, 'irenet', '6789',CONVERT(datetime, '2023-01-03 08:23:00',120));
insert into usuario values (13, 'jorgem', '6487',CONVERT(datetime, '2023-02-22 08:41:00',120));
insert into usuario values (14, 'karenv', '3523',CONVERT(datetime, '2023-02-24 11:57:00',120));
insert into usuario values (15, 'luisc', '7559',CONVERT(datetime, '2023-05-24 17:00:00',120));
insert into usuario values (16, 'mariar', '4221',CONVERT(datetime, '2023-05-01 14:30:00',120));
insert into usuario values (17, 'nicolasf', '1629',CONVERT(datetime, '2023-06-10 16:09:00',120));
insert into usuario values (18, 'oliviar', '8219',CONVERT(datetime, '2023-07-12 13:10:00',120));
insert into usuario values (19, 'pabloo', '1520',CONVERT(datetime, '2023-08-12 15:06:00',120));
...
insert into usuariorol values (1, 1,CONVERT(datetime,'2022-02-01 14:00:00',120), 'Activo');
